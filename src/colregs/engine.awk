...
function show_lights(key,th){
  ...
  #  to. A masthead light is carried within a quarter of her length from
  #  the stem and her sidelights are back on the bridge, so the sidelight
  #  falls toward her stern in the picture, not toward her bow. None of
  #  that survives to any real range: a 5 m offset at 2 miles is a
  #  fifteenth of a degree. Height and colour are what you actually get.
  printf "  %s\n", cwd("Sideways spacing is where the lights sit along her hull, close to.")
  printf "  %s\n", cwd("It is not a heading cue - at any real range they are all in line.")
  print ""
  return 0
}
